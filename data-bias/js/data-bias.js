...
const START_TEXT = gettext(
  "Klicken Sie auf jeden Punkt, den Sie auf dem Bildschirm sehen! Klicken Sie dann auf 'Weiter', um die Lösung anzuzeigen!"
);
const MISSED_CIRCLES_TEXT = gettext(
  "Sie scheinen einige Punkte verpasst zu haben! <br><br> Eine erzwungene Perspektive wie diese kann beeinflussen, welche Daten Sie sammeln, und kann die Gesamtergebnisse verzerren."
);
const SLIDER_TEXT = gettext(
  "Klicken Sie auf die Farbleiste, um die Hintergrundfarbe zu ändern. <br><br>Wie Sie Daten anzeigen, kann Ihre Interpretation beeinflussen."
);
const SLIDER_MIN = 0;

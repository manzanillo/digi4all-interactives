...
var eval = function () {
  ...
  var sliders = [fbSlider, twSlider, wikiSlider, ytSlider, glSlider];

  var facebookValue = fbSlider.noUiSlider
    .get()
    .replace(".", "")
    .replace(".", "");
  var twitterValue = twSlider.noUiSlider
    .get()
    .replace(".", "")
    .replace(".", "");
  ...
  let answers = [
    facebookValue - facebookValueDesired,
    twitterValue - twitterValueDesired,
    wikiValue - wikiValueDesired,
    ytValue - ytValueDesired,
    glValue - glValueDesired,
  ];
  console.log(answers);
  noUiSlider.create(fbSlider, {
    start: [
      Math.min(facebookValue, facebookValueDesired),
  ...
  noUiSlider.create(twSlider, {
    start: [
      Math.min(twitterValue, twitterValueDesired),
  ...
  noUiSlider.create(wikiSlider, {
    start: [
      Math.min(wikiValue, wikiValueDesired),
  ...
  noUiSlider.create(ytSlider, {
    start: [
      Math.min(ytValue, ytValueDesired),
  ...
  noUiSlider.create(glSlider, {
    start: [
      Math.min(glValue, glValueDesired),
  ...
  var tooltips = document.getElementsByClassName("noUi-base");
  ...
  for (var tooltip of tooltips) {
    ...
    tooltip.getElementsByClassName("noUi-tooltip")[index].style.top = "120%";
    tooltip.getElementsByClassName("noUi-tooltip")[index].style.bottom = "auto";
    tooltip.getElementsByClassName("noUi-tooltip")[
      index
    ].style.backgroundColor = "#26a69a";
    tooltip.getElementsByClassName("noUi-tooltip")[index].style.color = "white";

...
function setDecryptionText() {
  $('#interactive-rsa-no-padding-mode').text('Entschlüsselung');
  $('#interactive-rsa-no-padding-process').text('Entschlüsseln');
  $('#interactive-rsa-no-padding-input-type').text('Geheimtext');
  $('#interactive-rsa-no-padding-output-type').text('Klartext');
};
